...
scp -r ${DEPLOYMENT_DIR}/studentmeals ec2-user@ec2-51-20-138-253.eu-north-1.compute.amazonaws.com:~

echo -e "\n>> Starting up the servers ..\n"
ssh ec2-user@ec2-51-20-138-253.eu-north-1.compute.amazonaws.com \
